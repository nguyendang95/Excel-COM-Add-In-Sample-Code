// TaskPane.h : Declaration of the CTaskPane
#pragma once
...
class ATL_NO_VTABLE CTaskPane :
	...
	public IDispatchImpl<ITaskPane, &IID_ITaskPane, &LIBID_ExcelAddInLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
